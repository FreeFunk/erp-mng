...
public interface SysUserMapper  extends BaseMapper<SysUser>{
	...
	String selectByYewuUserId(String yewuUserId);

	String selectByInstallUserId(String installUserId);

	String selectByInputUserId(String inputUserId);
	 ...
	 * @return
	 */
    String selectByOutUserName(String outUserName);
	 ...
	 * @return
	 */
	String selectByInnerUser(String innerUserName);

	/**
	 * 根据id 和外勤条件查询
	 * @param newOutUserName
	 * @return
	 */
	String selectByOutUserNameId(String newOutUserName);


	SysUserView selectBySysUserName(String terminalUserName);

    void updateByXianQu(String id,String xianQiId, String name);
}