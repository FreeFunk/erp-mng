 ...
 **/
@Component
public class UpdateChangeNetRecIn {
    ...
    //q@Scheduled(cron = "0 0/1 * * * ?")
    public String tongBuChangeNetRec(){
        String changeNetUrl = sysConfigService.getValueById("CHANGE_NET_URL_1");
    ...
    public String timeStamp(){
        ...
        year = cal.get(Calendar.YEAR);//日
        String oneDay = "1";
        String lastDay;
        String newMonth = String.valueOf(month);
        if(newMonth.equals("1") || newMonth.equals("3") || newMonth.equals("5") || newMonth.equals("7") || newMonth.equals("8") || newMonth.equals("10") || newMonth.equals("12")){
            lastDay = "31";
        }else{
            lastDay = "30";
        }
    ...
    public String DepositJsonInDataBase(){
        ...
        //存放车辆信息对象集合
       //List<ErpCarInfo> erpCarInfo = erpCarInfoService.selectAll();
        ...
        for (ErpCarMsg1 erpCarMsgs:listJson) {
            ...
            erpChangeNetRec.setChangeNetType("转入");
            //现平台
    ...
    public String dynamicLoop(String toTal){
