...
public class CmsMngWebCodeGenIn {
	
	public static void main(String[] args) throws Exception {
		String templateDir = "template";
		//TODO:表名
		String tableName = "cms_article_content";
		//TODO:项目文件夹
		String projectDir = "cms-mng-web";
		//TODO:mapper文件夹
		String mapperDir = "cms";
		//TODO:模块包路径
		String modelpackage = "com.edgedo.cms.article";
		//TODO:前端的包路径
		String packageName = "cms.article";
		//TODO:访问url前缀
		String urlprefix = "/cms/article/";
		//TODO:生成代码连接数据库
		...
		String path = CmsMngWebCodeGenIn.class.getProtectionDomain().getCodeSource().getLocation().getFile();
